...
public class Patient {
    ...
    public Patient(double age, double sex, double cp, double trestbps, double chol,
                   double fbs, double restecg, double thalach, double exang, double oldpeak,
                   double slope, double ca, double thal, double num) {
        this.age = age;
        this.sex = sex;
        this.cp = cp;
